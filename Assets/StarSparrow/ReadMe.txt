...
-Added the spaceship examples in modular form as well as the single game object form.

We have also added 4 more examples and a unified set of materials for use with our spaceships collection after version 1.5